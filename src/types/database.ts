  ...
  public: {
    Tables: {
      ...
      fishing_spots: {
        ...
        Relationships: [
          {
            foreignKeyName: "fishing_spots_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
...
// ---- Atajos de uso común (DX Fishing) -------------------------------------
export type Profile = Tables<"profiles">
export type FishingSpot = Tables<"fishing_spots">
export type Catch = Tables<"catches">
export type NearbySpot =
  Database["public"]["Functions"]["nearby_spots"]["Returns"][number]
